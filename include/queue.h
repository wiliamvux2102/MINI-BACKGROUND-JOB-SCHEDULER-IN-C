...
static inline int queue_isempty(const queue_t * q) { return !q || q->size == 0; } // return 1/0 for true/false
static inline size_t queue_size(const queue_t * q) { return (q ? q->size: 0); }
